...
const getExpenseById = asyncWrapper(async (req, res) => {
  ...
  if (!expense) {
    return apiResponse.error(res, 'Expense record not found.', 404);
  }
  return apiResponse.success(res, expense, 'Expense record retrieved successfully.');
});
...
const updateExpense = asyncWrapper(async (req, res) => {
  ...
  return apiResponse.success(res, updatedExpense, 'Expense record updated successfully.');
});
...
const deleteExpense = asyncWrapper(async (req, res) => {
  ...
  return apiResponse.success(res, deletedExpense, 'Expense record deleted successfully.');
});
